from db_connection import connect_to_database  # Ensure you have this module
from prettytable import PrettyTable
from mysql.connector import Error
from restaurant import RestaurantMenu  # Ensure you have this module
from abc import ABC, abstractmethod

class Customer:
    def __init__(self, name, address, check_in_date, check_out_date, room_no, user_email):
        self.name = name
    ...
    def __str__(self):
        return (f"Name: {self.name}, Address: {self.address}, "
                f"Check-in Date: {self.check_in_date}, Check-out Date: {self.check_out_date}, "
                f"Room No.: {self.room_no}, User Email: {self.user_email}")
...
class Admin(AbstractUser):
    ...
    def admin_login(self):
        ...
        if username == self._email and password == self._password:
...
class BookingDisplay:
    ...
    def display_bookings(self, email=None):
        ...
        params = (email,) if email else None
...
class Hotel(BookingDisplay):
    ...
    def input_customer_data(self):
        ...
        try:
            ...
            room_price = self._cursor.fetchone()[0]
        ...
        while True:
            if not self._admin_logged_in and not self._user_logged_in:
                ...
                if choice == 1:
                    ...
                    self._add_new_user(user_email, password)
                elif choice == 6:
                    self.rooms_info()
                elif choice == 7:
                    self.admin_logout()
